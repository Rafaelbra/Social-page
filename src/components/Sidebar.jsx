    ...
    return (
        <aside className={styles.sidebar}>
            ...
            <div className={styles.profile}>
                <Avatar src='https://images.unsplash.com/photo-1533738363-b7f9aef128ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=65&q=750' />
